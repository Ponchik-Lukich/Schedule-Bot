...
const (
	...
	Any                 = "Всё равно"
	Commands            = "\n<b>Поиск свободного кабинета</b> - найти интервал, когда кабинет свободен по заданной дате и времени \n\n<b>Информация о кабинете</b> - отобразить информацию (расписание) о кабинете."
)
